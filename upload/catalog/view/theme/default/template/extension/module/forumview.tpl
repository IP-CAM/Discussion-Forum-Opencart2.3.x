...
<div class="container">
  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-heading">
        ...
        <h3 class="panel-title"><i class="fa fa-list"></i>  <?php echo $heading_title; ?><span style="float:right;" title="Go back"><a href="<?php echo $base; ?>index.php?route=extension/module/forum/addTopic" title="Add Topic">Start Discussion</a></span></h3>
  ...
  <table class="table table-bordered table-hover">
    <tbody>
      <tr style="background: #2094c0;color:#fff;">
        <td><strong><a style="color:#e1e1e1;" href="<?php if($forumdata[$i]['customer_id'] == 0) { print $base.'index.php?route=extension/module/forum/getForums'; } else { print $base.'index.php?route=extension/module/forum/getForums&author_id='.base64_encode($forumdata[$i]['customer_id']); } ?>">
  ...
  <table class="table table-bordered table-hover">
    <tbody>
      <tr>
        <td><strong><?php print "  #".$j; ?><?php print " reply on : "; ?></strong> <?php print $forumreplydata[$i]['name']." by "; ?><a href="<?php print $base.'index.php?route=extension/module/forum/getForums&author_id='.base64_encode($forumreplydata[$i]['customer_id']);?>"><?php print $forumreplydata[$i]['username']; ?></a> </td>
